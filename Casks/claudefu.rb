cask "claudefu" do
  version "0.2.7"
  sha256 "dda7205474240facc573ba6455ef64646d5814a507ab9f294118776ab1997f8d"

  url "https://github.com/metaphori-ai/claudefu/releases/download/v#{version}/ClaudeFu-#{version}-darwin-universal.zip"
  name "ClaudeFu"
